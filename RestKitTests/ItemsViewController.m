...
- (void)viewDidLoad
{
    ...
    [[RKObjectManager sharedManager] loadObjectsAtResourcePath:@"/items" delegate:self];     
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Item *item = (Item *)[self.objects objectAtIndex:indexPath.row];
    cell.textLabel.text = item.name;
    cell.detailTextLabel.text = item.category ? item.category.name : @"-";    
